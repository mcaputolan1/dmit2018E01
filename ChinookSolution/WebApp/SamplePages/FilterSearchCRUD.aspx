 ...
 <h1>Filter Search</h1>
    ...
    <div class="col-md-offset-1">
        ...
        <asp:RangeValidator ID="RangeEditReleaseYear" runat="server" 
            ErrorMessage="Year needs to be between 1950 and today" Display="None"
            ForeColor="Firebrick" SetFocusOnError="true" ControlToValidate="EditReleaseYear"
       ...
       <asp:DropDownList ID="EditAlbumArtistList" runat="server" DataSourceID="EditArtistListODS" DataTextField="Name" DataValueField="ArtistId"></asp:DropDownList>
        ...
        <asp:LinkButton ID="Remove" runat="server" CausesValidation="false" 
            OnClick="Remove_Click" OnClientClick="return confirm('Are you sure you wish to remove this album from the collection?')">Remove</asp:LinkButton>
    </div>
