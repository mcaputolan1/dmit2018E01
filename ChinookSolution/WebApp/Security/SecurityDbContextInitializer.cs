...
namespace WebApp.Security
{
    public class SecurityDbContextInitializer : CreateDatabaseIfNotExists<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            List<string> employeeroles = sysmgr.Employees_GetTitle();
            ...
            //- foreach employee
            //  - create UserName such as LastName and FirstInitial and possibly add a number if there is a duplicate
            //  - email of employee or null or add @Chinook.somewhere.ca to UserName
            //  - EmployeeId is the pkey of the Employee record
            //  use the appsetting newUserPassword for the password
            //  on the succeeded, the role can come from the Employee record
